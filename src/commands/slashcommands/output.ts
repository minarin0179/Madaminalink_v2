import { ChannelType, SlashCommandBuilder, TextChannel, Attachment } from "discord.js";
...
export default new SlashCommand({
    ...
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(option =>
            option.setName("入力").setDescription("作成するチャンネル")
    ...
    execute: async ({ interaction, args }) => {
        ...
        const messages = JSON.stringify(
            (await originalChannel.messages.fetch()).map(message => {
                return {
