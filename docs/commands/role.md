...
| オプション | 必須 | 説明 |
|-----------|------|------|
| 付与するロール | いいえ | セルフロールボタンを作成するロール。省略するとロール一覧から選択 |
...
::: warning 注意
「ボタンを他の人からも見えるようにする」で「はい」を選択した場合、誰でもボタンを押せるようになります。設置するチャンネルに注意してください。
:::

::: tip ヒント
マダミナリンクより上位のロールは操作できません。詳しくは[ロールの並び替え](/guide/getting-started#_1-ロールの並び替え)を参照してください。
:::
