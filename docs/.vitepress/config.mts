...
const softwareAppSchema = {
    ...
    description:
        "マーダーミステリー向けDiscord Bot。GMの作業を効率化する多機能Bot。",
    url: SITE_URL,
    author: {
        "@type": "Person",
        name: "minarin0179",
...
function generateHowToSchema(): object {
    return {
        ...
        name: "マダミナリンクの導入方法",
        description:
            "マダミナリンクをDiscordサーバーに導入し、使い始めるまでの手順を説明します。",
        totalTime: "PT5M",
        step: [
            {
                "@type": "HowToStep",
...
export default defineConfig({
    ...
    head: [
        ...
        [
            "meta",
            {
                name: "keywords",
                content:
                    "マダミナリンク,マーダーミステリー,Discord,Bot,GM,TRPG,シナリオ管理,ログ保存,チャンネル管理",
            },
        ],
        ...
        [
            "meta",
            { property: "og:site_name", content: "マダミナリンク 公式ガイド" },
        ],
    ...
    themeConfig: {
        ...
        socialLinks: [
            {
                icon: "github",
                link: "https://github.com/minarin0179/Madaminalink_v2",
            },
            {
                icon: "discord",
                link: "https://discord.com/discovery/applications/926051893728403486",
            },
        ...
        footer: {
            message:
                'マダミナリンク 公式ガイド - マーダーミステリー向けDiscord Bot | <a href="/legal/privacy-policy">プライバシーポリシー</a> | <a href="/legal/terms">利用規約</a>',
        ...
        editLink: {
            pattern:
                "https://github.com/minarin0179/Madaminalink_v2/edit/main/docs/:path",
            text: "このページを編集する",
        },
